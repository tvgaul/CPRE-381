...
vsim -voptargs=+acc work.tb_MyFirstMIPSDatapath


add wave -noupdate -radix signed /tb_MyFirstMIPSDatapath/*
...
#add wave -noupdate -radix unsigned /tb_MyFirstMIPSDatapath/*
