...
##              tb_reg_N unit. It adds some useful signals for testing
...
add wave -noupdate -color magenta -radix unsigned /tb_reg_N/s_WE
add wave -noupdate -color magenta -radix hexadecimal /tb_reg_N/s_D
...
add wave -noupdate -color orange -radix hexadecimal /tb_reg_N/s_Q

# Test Inputs
add wave -noupdate -divider {Test Signals}
add wave -noupdate -color cyan -radix hexadecimal /tb_reg_N/s_Q_Expected
add wave -noupdate -color cyan -radix unsigned /tb_reg_N/s_Q_Mismatch
...
# add wave -noupdate -radix unsigned /tb_reg_N/DUT0/*
