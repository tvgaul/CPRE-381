...
##              tb_full_adder unit. It adds some useful signals for testing
...
add wave -noupdate -radix unsigned /tb_full_adder/s_i_X
add wave -noupdate -radix unsigned /tb_full_adder/s_i_Y
add wave -noupdate -radix unsigned /tb_full_adder/s_i_Cin
...
add wave -noupdate -radix unsigned /tb_full_adder/s_o_S
add wave -noupdate -radix unsigned /tb_full_adder/s_o_Cout
...
add wave -noupdate /tb_full_adder/DUT0/*
